...
let data = localStorage.getItem('TODO') //esto sirve para que no se borren las tareas al recargar la pagina
if(data){
    LIST = JSON.parse(data) //Json parse convierte el string en un objeto
    console.log(LIST)
    id = LIST.length
    cargarLista(LIST)
}else {
